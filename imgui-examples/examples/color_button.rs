...
fn example_selector(state: &mut State, ui: &Ui) {
    ui.window("Color button examples")
...
fn example_1(state: &mut State, ui: &Ui) {
    ui.window("Example 1: Basics")
        ...
        .build(|| {
            ...
            if ui.color_button("Green color", (0.0, 1.0, 0.0, 1.0))
                .size((100.0, 50.0))
                .build()
            {
            ...
            if ui.color_button("No tooltip", (0.0, 0.0, 1.0, 1.0))
                .tooltip(false)
                .build()
            {
...
fn example_2(ui: &Ui) {
    ui.window("Example 2: Alpha component")
        ...
        .build(|| {
            ...
            ui.color_button("Red color", (1.0, 0.0, 0.0, 0.5))
                .alpha(false)
                .build();
            ...
            ui.color_button("Red + ColorPreview::Opaque", (1.0, 0.0, 0.0, 0.5))
            ...
            ui.color_button("Red + ColorPreview::Alpha", (1.0, 0.0, 0.0, 0.5))
