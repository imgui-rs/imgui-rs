...
macro_rules! impl_operator_overloads_vec2 {
    ($trait_name:ident, $fn_name:ident) => (
        impl $trait_name for ImVec2 {
            type Output = ImVec2;

            fn $fn_name(self, other: ImVec2) -> ImVec2 {
                ImVec2::new(
...
macro_rules! impl_assign_overloads_vec2 {
    ($trait_name:ident, $fn_name:ident) => (
        impl $trait_name for ImVec2 {
            fn $fn_name(&mut self, other: ImVec2) {
...
impl_operator_overloads_vec2!(Add, add);
impl_operator_overloads_vec2!(Sub, sub);
impl_operator_overloads_vec2!(Mul, mul);
impl_operator_overloads_vec2!(Div, div);
impl_operator_overloads_vec2!(Rem, rem);

impl_assign_overloads_vec2!(AddAssign, add_assign);
impl_assign_overloads_vec2!(SubAssign, sub_assign);
impl_assign_overloads_vec2!(MulAssign, mul_assign);
impl_assign_overloads_vec2!(DivAssign, div_assign);
impl_assign_overloads_vec2!(RemAssign, rem_assign);
...
macro_rules! impl_operator_overloads_vec4 {
    ($trait_name:ident, $fn_name:ident) => (
        impl $trait_name for ImVec4 {
            type Output = ImVec4;

            fn $fn_name(self, other: ImVec4) -> ImVec4 {
                ImVec4::new(
                    $trait_name::$fn_name(self.x, other.x),
                    $trait_name::$fn_name(self.y, other.y),
...
macro_rules! impl_assign_overloads_vec4 {
    ($trait_name:ident, $fn_name:ident) => (
        impl $trait_name for ImVec4 {
            fn $fn_name(&mut self, other: ImVec4) {
                $trait_name::$fn_name(&mut self.x, other.x);
                $trait_name::$fn_name(&mut self.y, other.y);
...
impl_operator_overloads_vec4!(Add, add);
impl_operator_overloads_vec4!(Sub, sub);
impl_operator_overloads_vec4!(Mul, mul);
impl_operator_overloads_vec4!(Div, div);
impl_operator_overloads_vec4!(Rem, rem);

impl_assign_overloads_vec4!(AddAssign, add_assign);
impl_assign_overloads_vec4!(SubAssign, sub_assign);
impl_assign_overloads_vec4!(MulAssign, mul_assign);
impl_assign_overloads_vec4!(DivAssign, div_assign);
impl_assign_overloads_vec4!(RemAssign, rem_assign);
...
macro_rules! test_operator_assign {
    ($a:ident, $b:ident, $operator:tt, $operator_assign:tt) => (
        let mut ma = $a;
        ma $operator_assign $b;
        assert_eq!(ma, $a $operator $b);
    )
}
