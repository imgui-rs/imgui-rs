...
impl ::core::fmt::Debug for ImDrawListSharedData {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        write ! (f , "ImDrawListSharedData {{ TexUvWhitePixel: {:?}, Font: {:?}, FontSize: {:?}, CurveTessellationTol: {:?}, CircleSegmentMaxError: {:?}, ClipRectFullscreen: {:?}, InitialFlags: {:?}, ArcFastVtx: {:?}, CircleSegmentCounts: [...], TexUvLines: {:?} }}" , self . TexUvWhitePixel , self . Font , self . FontSize , self . CurveTessellationTol , self . CircleSegmentMaxError , self . ClipRectFullscreen , self . InitialFlags , self . ArcFastVtx , self . TexUvLines)
    }
}
#[repr(C)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
#[link(wasm_import_module = "imgui-sys-v0")]
extern "C" {
    pub fn igTableSetColumnEnabled(column_n: cty::c_int, enabled: bool);
}
#[link(wasm_import_module = "imgui-sys-v0")]
extern "C" {
