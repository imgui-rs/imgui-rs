...
pub enum StyleColor {
    Text = sys::ImGuiCol_Text as u32,
    TextDisabled = sys::ImGuiCol_TextDisabled as u32,
    /// Background of normal windows
    WindowBg = sys::ImGuiCol_WindowBg as u32,
    /// Background of child windows
    ChildBg = sys::ImGuiCol_ChildBg as u32,
    /// Background of popups, menus, tooltips windows
    PopupBg = sys::ImGuiCol_PopupBg as u32,
    Border = sys::ImGuiCol_Border as u32,
    BorderShadow = sys::ImGuiCol_BorderShadow as u32,
    /// Background of checkbox, radio button, plot, slider, text input
    FrameBg = sys::ImGuiCol_FrameBg as u32,
    FrameBgHovered = sys::ImGuiCol_FrameBgHovered as u32,
    FrameBgActive = sys::ImGuiCol_FrameBgActive as u32,
    TitleBg = sys::ImGuiCol_TitleBg as u32,
    TitleBgActive = sys::ImGuiCol_TitleBgActive as u32,
    TitleBgCollapsed = sys::ImGuiCol_TitleBgCollapsed as u32,
    MenuBarBg = sys::ImGuiCol_MenuBarBg as u32,
    ScrollbarBg = sys::ImGuiCol_ScrollbarBg as u32,
    ScrollbarGrab = sys::ImGuiCol_ScrollbarGrab as u32,
    ScrollbarGrabHovered = sys::ImGuiCol_ScrollbarGrabHovered as u32,
    ScrollbarGrabActive = sys::ImGuiCol_ScrollbarGrabActive as u32,
    CheckMark = sys::ImGuiCol_CheckMark as u32,
    SliderGrab = sys::ImGuiCol_SliderGrab as u32,
    SliderGrabActive = sys::ImGuiCol_SliderGrabActive as u32,
    Button = sys::ImGuiCol_Button as u32,
    ButtonHovered = sys::ImGuiCol_ButtonHovered as u32,
    ButtonActive = sys::ImGuiCol_ButtonActive as u32,
    Header = sys::ImGuiCol_Header as u32,
    HeaderHovered = sys::ImGuiCol_HeaderHovered as u32,
    HeaderActive = sys::ImGuiCol_HeaderActive as u32,
    Separator = sys::ImGuiCol_Separator as u32,
    SeparatorHovered = sys::ImGuiCol_SeparatorHovered as u32,
    SeparatorActive = sys::ImGuiCol_SeparatorActive as u32,
    ResizeGrip = sys::ImGuiCol_ResizeGrip as u32,
    ResizeGripHovered = sys::ImGuiCol_ResizeGripHovered as u32,
    ResizeGripActive = sys::ImGuiCol_ResizeGripActive as u32,
    Tab = sys::ImGuiCol_Tab as u32,
    TabHovered = sys::ImGuiCol_TabHovered as u32,
    TabActive = sys::ImGuiCol_TabActive as u32,
    TabUnfocused = sys::ImGuiCol_TabUnfocused as u32,
    TabUnfocusedActive = sys::ImGuiCol_TabUnfocusedActive as u32,
    PlotLines = sys::ImGuiCol_PlotLines as u32,
    PlotLinesHovered = sys::ImGuiCol_PlotLinesHovered as u32,
    PlotHistogram = sys::ImGuiCol_PlotHistogram as u32,
    PlotHistogramHovered = sys::ImGuiCol_PlotHistogramHovered as u32,
    TextSelectedBg = sys::ImGuiCol_TextSelectedBg as u32,
    DragDropTarget = sys::ImGuiCol_DragDropTarget as u32,
    /// Gamepad/keyboard: current highlighted item
    NavHighlight = sys::ImGuiCol_NavHighlight as u32,
    /// Highlight window when using CTRL+TAB
    NavWindowingHighlight = sys::ImGuiCol_NavWindowingHighlight as u32,
    /// Darken/colorize entire screen behind the CTRL+TAB window list, when active
    NavWindowingDimBg = sys::ImGuiCol_NavWindowingDimBg as u32,
    /// Darken/colorize entire screen behind a modal window, when one is active
    ModalWindowDimBg = sys::ImGuiCol_ModalWindowDimBg as u32,
}
